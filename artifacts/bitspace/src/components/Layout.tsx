...
import { Home, Map, Users, Ticket, BarChart2, Music2 } from "lucide-react";
        ...
        <div className="p-4 border-t border-border">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium truncate">Luca Ferri</p>
              <p className="text-xs text-muted-foreground truncate">Fan</p>
            </div>
          </div>
        </div>
      </aside>
