...
await db.insert(merchTable).values([
  // Aurora Nova
  { artistId: artistProfiles[0].id, name: "T-Shirt Notte Digitale", category: "Magliette", price: 28, stock: 50, description: "T-shirt nera con stampa artwork di 'Notte Digitale'. 100% cotone biologico.", imageUrl: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&q=80", badge: "Nuovo" },
  { artistId: artistProfiles[0].id, name: "Hoodie Aurora Nova", category: "Felpe", price: 55, stock: 30, description: "Felpa con cappuccio oversize. Stampa ricamata del logo Aurora Nova.", imageUrl: "https://images.unsplash.com/photo-1556821840-3a63f15732ce?w=400&q=80", badge: "" },
  { artistId: artistProfiles[0].id, name: "Vinile Pixel Dreams EP", category: "Vinili", price: 22, stock: 100, description: "EP da 4 tracce su vinile 12\" colorato. Edizione limitata numerata.", imageUrl: "https://images.unsplash.com/photo-1542208998-f6dbbb27b569?w=400&q=80", badge: "Limited" },
  // Velvet Echo
  { artistId: artistProfiles[1].id, name: "T-Shirt Strade di Notte", category: "Magliette", price: 24, stock: 40, description: "T-shirt grigio mélange. Design minimalista con skyline romano.", imageUrl: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&q=80", badge: "" },
  { artistId: artistProfiles[1].id, name: "Poster Tour 2026", category: "Poster", price: 12, stock: 200, description: "Poster del tour autunnale 2026. Stampa alta qualità A2 su carta lucida.", imageUrl: "https://images.unsplash.com/photo-1534430480872-3498386e7856?w=400&q=80", badge: "Esclusivo" },
  // Neon Pulse
  { artistId: artistProfiles[2].id, name: "Bucket Hat Neon Pulse", category: "Accessori", price: 30, stock: 60, description: "Cappello bucket con logo neon ricamato. One size. Perfetto per i festival.", imageUrl: "https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=400&q=80", badge: "Best Seller" },
  { artistId: artistProfiles[2].id, name: "T-Shirt 404 BPM", category: "Magliette", price: 26, stock: 80, description: "Grafica glitch art sul davanti. Stampa serigrafata su cotone pesante.", imageUrl: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&q=80", badge: "Nuovo" },
  { artistId: artistProfiles[2].id, name: "USB Rave Kit", category: "Accessori", price: 18, stock: 150, description: "Chiavetta USB con 2 ore di mix esclusivi e stems delle tracce più famose.", imageUrl: "https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=400&q=80", badge: "" },
  // Luna Mare
  { artistId: artistProfiles[3].id, name: "Sciarpa Sirene di Napoli", category: "Accessori", price: 20, stock: 35, description: "Sciarpa in seta stampata con illustrazione del Golfo di Napoli.", imageUrl: "https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=400&q=80", badge: "" },
